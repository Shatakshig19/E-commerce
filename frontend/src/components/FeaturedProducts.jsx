...
function FeaturedProducts({ featuredProducts }) {
    const [currentIndex, setCurrentIndex] = useState(0); {/*current index pehle wala index matlab first product jiska index 0 hai phir jab slider wale arrow par click hoga tab currentIndex 4 ho jayega kyuki 4 wala first position par aa jayegaa */}
            ...
            <div className="overflow-hidden">
              ...
              >
                {featuredProducts?.map((product) => (
                  ...
                  >
                    <div className="bg-white bg-opacity-10 backdrop-blur-smrounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border-emerald-500/30">
                      <div className="overflow-hidden">
                        <img
                          src={product.image}
                          alt={product.name}
